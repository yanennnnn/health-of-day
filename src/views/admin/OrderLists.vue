<template>
    <div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr v-for="item in orders" :key="item.id">
                            ...
                            <td >
                                <button type="button" class="btn btn-primary" @click.prevent="checkModal(item)" >查看</button>
                                <button type="button" class="btn btn-outline-middle-green-yellow" @click.prevent="updateModal(item)" >編輯</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="modal fade" id="checkModal" tabindex="-1" role="dialog" aria-labelledby="checkModlTitle" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-body" v-if="tempOrder.user">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" onkeyup="value=value.replace(/[^0-9]/g,'')" class="form-control" id="tel"
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-muted" data-dismiss="modal">取消</button>
                        <button type="button" class="btn btn-primary" @click.prevent="updateOrder">確定</button>
                </div>
                </div>
            </div>
        </div>
